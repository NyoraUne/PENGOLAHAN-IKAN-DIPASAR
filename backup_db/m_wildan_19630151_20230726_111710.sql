...
CREATE TABLE `tb_comment` (
  ...
  `isi` varchar(225) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id_comment`),
  KEY `id_berita` (`id_berita`),
  KEY `id_login` (`id_login`),
  CONSTRAINT `tb_comment_ibfk_1` FOREIGN KEY (`id_berita`) REFERENCES `tb_berita` (`id_berita`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_comment_ibfk_2` FOREIGN KEY (`id_login`) REFERENCES `tb_login` (`id_login`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tb_comment` VALUES (1,4,3,'Ikan lele saya mati semua,ternyata ini penyebab nya.\r\n','2023-07-26 03:05:36'),(2,4,2,'hama ikan paling di takuti sma kita\r\n','2023-07-26 03:06:05'),(3,4,2,'tapi udh tau obat nya apa, jadi aman','2023-07-26 03:06:18');
...
-- Dump completed on 2023-07-26 11:17:10
