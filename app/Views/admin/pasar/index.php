                        ...
                        <?php foreach ($pasar as $pa) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('Con_pasar/hapus_pasar/' . $pa['id_pasar']) ?>" class="btn btn-outline-danger btn-ssm custom-btn" onclick="confirm('apakah anda yakin untuk menghapus data?')">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
