...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="<?= base_url('/'); ?>"><img src="<?= base_url('src/'); ?>img/Tapin.png" alt="" style="height: 35px; width: 30px;"> DISKAN</a>
        <!-- Sidebar Toggle-->
                            ...
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        ...
                                        <a class="nav-link" href="<?= base_url('Lap_trans') ?>">Laporan Keluar/Masuk</a>
                                        <a class="nav-link" href="<?= base_url('Lap_berita') ?>">Laporan Berita</a>
                                    </nav>
                                </div>
                            </nav>
                        </div>
